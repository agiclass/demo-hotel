...
- 🎯 Entry points to execute your program using `python -m <hotel_chatbot>` or `$ hotel_chatbot` with basic CLI argument parsing.
...
Awesome hotel_chatbot created by toddlt

## Install it from PyPI

```bash
pip install hotel_chatbot
```

## Usage

```py
from hotel_chatbot import BaseClass
from hotel_chatbot import base_function
